      ...
      <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
        <Layout className="pt-0">
          <div className="flex items-center justify-between w-full">
            <div className="w-1/2">
              <Image src={profilePic} alt="Fardhan Mauladi" className="w-full h-auto" priority sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw" />
            </div>
            <div className="w-1/2 flex flex-col items-center self-center">
              ...
              <div className="flex items-center self-start mt-2">
                ...
                <Link href="mailto:fardhan16@gmail.com" target="_blank" className="ml-4 text-lg font-medium capitalize textdark underline dark:text-light">
                  Contact
                </Link>
              </div>
            </div>
