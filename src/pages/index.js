  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Portfolio Fardhan Mauladi" />
      </Head>
      <TransitionEffect />
        ...
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className="w-1/2 md:w-full">
              <Image src={profilePic} alt="Fardhan Mauladi" className="w-full h-auto lg:hidden md:inline-block md:w-full" priority sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw" />
            </div>
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                As a skilled Frontend developer, I am dedicated to turning ideas into innovative web applications and moblie applications. Explore my latest projects, showcasing my expertise in React.js and web development.
              </p>
